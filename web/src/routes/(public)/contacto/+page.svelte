<script>
  import { PHONE, WA, EMAIL } from '$lib/contact.js';
</script>

<svelte:head>
  <title>Contacto — Pichel</title>
</svelte:head>

<section class="info-section info-section--alt info-section--first">
  <div class="info-wrap">
    <h2 class="info-title">Contacto</h2>
    <p class="info-text">¿Consultas sobre productos, precios o pedidos? Escribinos.</p>
    <div class="contact-buttons">
      <a href="mailto:{EMAIL}" class="btn btn-primary contact-btn">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
        </svg>
        {EMAIL}
      </a>
      <a href="tel:{PHONE}" class="btn btn-ghost contact-btn">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="https://wa.me/{WA}" target="_blank" rel="noopener" class="btn btn-whatsapp contact-btn">
